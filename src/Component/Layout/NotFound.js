...
export default function NotFound() {
  return (
    <div className="not-found-cls">
      <img src={`${process.env.PUBLIC_URL}/Images/404_Page.png`} alt="404 Found Page" />
      <h2>OOPS! You are looking something has temporarly removed.</h2>
      <p>
...
//   useEffect(() => {
//     const monkeySVG = Snap(svgRef.current);
...
//     const intervalId = setInterval(animateTail, 3200);
//     return () => clearInterval(intervalId);
//   }, []);

//   return (
//     <div classNameName="not-found-cls">
